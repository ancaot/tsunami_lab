...
tsunami_lab::t_real tsunami_lab::setups::ArtificialTsunami2d::getMomentumX(t_real i_x, t_real i_y) const {
    //
    return m_momentumX;
}

tsunami_lab::t_real tsunami_lab::setups::ArtificialTsunami2d::getMomentumY(t_real i_x, t_real i_y) const {
    //
    return m_momentumY;
}
