...
Mein Teil der Aufgabe (Zusammenfassung für die Präsentation)
=============================================================
...
"""
with open(r'd:\studium\tsunami_lab\sphinx\source\chapters\submission_5.rst', 'w', encoding='utf-8') as f:
    f.write(content)